...
if __name__ == "__main__":
    ...
    #residuals = perform_regression_analysis("../data/DRL/2025-09-17_18-28-02/tooltip_positions.csv", 3, cutoff=20)
    residuals = perform_regression_analysis("../data/DRL/2025-09-17_18-37-41/tooltip_positions.csv", 3, cutoff=50)
    plot_residuals(residuals)
    plot_qq(residuals)
    plot_autocorrelation_and_fft(residuals, 0.1)
